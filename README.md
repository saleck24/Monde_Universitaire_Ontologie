...
Le logiciel IsaViz n'est pas inclus dans ce dépôt pour des raisons de taille. Vous pouvez le télécharger sur le site officiel du W3C : https://www.w3.org/2001/11/IsaViz/

Structure de l'Ontologie
L'ontologie est organisée autour de 4 axes principaux :

Personne : Etudiant, Professeur.
Organisation : Universite, Faculte, Departement.
Activite : Cours.
Infrastructure : Salle.
Instances incluses
...
Téléchargez et installez Protégé.
Lancez Protégé.
Allez dans File -> Open... et sélectionnez le fichier universite_ontology.owl.
Vous pouvez visualiser la hiérarchie dans l'onglet Entities -> Classes.
Les données (individus) se trouvent dans l'onglet Entities -> Individuals.
2. Visualiser avec IsaViz
Double-cliquez sur le fichier lance_isaviz.bat que j'ai créé à la racine du dossier.
Une fois IsaViz ouvert :
Allez dans File -> Import... -> RDF/XML...
Sélectionnez votre fichier universite_ontology.owl.
L'outil générera un graphe RDF montrant les relations entre les différents concepts.
